    ...
    showAll && (
     ...
     <div 
      className='flex items-start justify-center headerHover relative'>
        ...
        <p 
        className='hidden sm:inline-flex text-xs font-semibold mt-3 text-whiteText'>
            Cart {''}
            <span 
            className='absolute text-xs top-0 left-6 w-4 font-semibold p-1 h-4 bg-[#f3a847] text-amazon_blue rounded-full flex justify-center items-center'>
