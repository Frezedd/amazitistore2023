        ...
        <div className="container mx-auto h-auto grid grid-cols-5 gap-8">
          <div className="w-full bg-white px-4 col-span-5 xl:col-span-4">
            ...
            <div className="font-titleFont  xl:flex items-center justify-between border-b-[1px] border-b-gray-400 py-3">
              ...
              <h3 className="text-xl font-semibold animate-bounce hidden xl:flex">Subtotal</h3>
            </div>
            {/* ====================== Cart title End here ========================= */}
            {/* ====================== Products Start here ========================= */}
            <div>
          ...
          <div className="col-span-5 md:col-span-3 lg:col-span-2 xl:col-span-1 bg-white h-52 flex items-center p-4 ">
            <div>
              ...
              <p className="flex flex-col items-center text-xs mt-3 text-red-500 font-semibold animate-bounce">Please login to continue</p>
            </div>
          </div>
        </div>
        ...
        <motion.div
          ...
          <div className="w-96 p-4 bg-white flex  flex-col items-center rounded-md shadow-lg">
            ...
            <p className="text-sm text-center group ">
              ...
              <Link to='/'>
              <span className="text-blue-600 group-hover:text-orange-700 group-hover:underline underline-offset-1"> Amazon.com </span>
              </Link>
            </p>
            <Link to="/">
